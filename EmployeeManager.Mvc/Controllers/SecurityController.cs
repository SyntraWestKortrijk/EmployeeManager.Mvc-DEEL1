    ...
    public class SecurityController : Controller
    {
        ...
        public IActionResult Register(Register obj)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    StringBuilder sb_Errors = new StringBuilder("Invalid user details - number of errors: ");
                    sb_Errors.Append(result.Errors.Count());
                    foreach (IdentityError e in result.Errors) {
                        sb_Errors.Append(" - " + e.Description);
                    }
                    ModelState.AddModelError("", sb_Errors.ToString());
                }
            }
            return View(obj);
        }
